...
function TeamMemberImage({ member }) {
  const svgFallback = `data:image/svg+xml,${encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><rect fill="#1a1f2e" width="200" height="200"/><text x="50%" y="50%" text-anchor="middle" dy=".3em" fill="#ff9900" font-size="48" font-family="Inter, sans-serif" font-weight="700">${member.initials}</text></svg>`
  )}`;
              ...
              <div className="team-card-info">
                ...
                <div className="team-card-socials">
                  ...
                  {member.socials?.twitter && (
                    <a href={member.socials.twitter} aria-label="Twitter" className="social-link" target="_blank" rel="noopener noreferrer">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
